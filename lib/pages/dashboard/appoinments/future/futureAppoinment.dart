...
import 'dart:convert';
import 'DayFutureAppoinments.dart';

import 'package:http/http.dart' as http;
// My Own Import
import 'package:my_store/pages/login_signup/forgot_password.dart';

class FutureAppoinment extends StatefulWidget {
  List cats ;
  FutureAppoinment(this.cats);
  @override
  _FutureAppoinmentState createState() => _FutureAppoinmentState();
}

class _FutureAppoinmentState extends State<FutureAppoinment> {
  bool _isload = false;
                            ...
                            return Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (BuildContext context) {
                                   return DayFutureAppoinments(item["date"])    ;
                                },
                              ),
                            );
                          },
