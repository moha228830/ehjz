...
import 'DayEndAppoinment.dart';

// My Own Import
import 'package:my_store/pages/login_signup/forgot_password.dart';

class EndAppoinment extends StatefulWidget {
  List cats ;
  EndAppoinment(this.cats);
  @override
  _EndAppoinmenttState createState() => _EndAppoinmenttState();
}

class _EndAppoinmenttState extends State<EndAppoinment> {
  bool _isload = false;
                            ...
                            return Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (BuildContext context) {
                                  return DayEndAppoinments(item["date"])    ;
                                },
                              ),
                            );
                          },
