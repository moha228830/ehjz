...
class DayCloseAppoinments extends StatefulWidget {
  var date;

  DayCloseAppoinments(this.date);
  @override
  _DayCloseAppoinmentssState createState() => _DayCloseAppoinmentssState();
}

class _DayCloseAppoinmentssState extends State<DayCloseAppoinments> {
  bool _isload = true;
  String token ;
  int place_id;
  List my_data = [];
          ...
          Center(
            child: Column(
              ...
              children: [
                ...
                Text("لا يوجد بيانات",style: TextStyle(fontFamily: "Cairo",fontSize: 13.0.sp),)
              ],),
          )
              :
          ListView.builder(
