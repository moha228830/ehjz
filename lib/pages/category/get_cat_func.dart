...
Future<List<CategoryModel>> fetchCats(http.Client client, page,offset,id) async {
  final response = await client
      .get(Config.url + 'getSubCategories?id='+id +'&page=' + page.toString()+ '&offset=' + offset.toString());
...
List<CategoryModel> parseCats(responseBody) {
  final parsed =
  jsonDecode(responseBody)["data"]["sub"].cast<Map<String, dynamic>>();
  print(parsed);
